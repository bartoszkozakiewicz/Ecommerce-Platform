  ...
  return (
    <div className="bg-[#E0E0E0] py-10 md:py-20">
      ...
      <div className="flex justify-center">
        ...
        <button className="ml-2 flex w-1/12 items-center justify-center rounded-lg bg-gradient-to-b from-[#127FFF] to-[#0067FF] px-16 text-center text-sm font-semibold tracking-wider text-white outline-none transition-all duration-700 hover:-translate-y-1 md:ml-5 md:p-2 md:px-5 md:text-xs lg:ml-10 lg:p-0 lg:text-base">
          Subscribe
        </button>
      </div>
    </div>
